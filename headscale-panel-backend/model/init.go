...
func initDefaultData() {
	...
	permissions := []Permission{
		...
		{Name: "查看容器", Code: "docker:container:list", Type: "button"},
		{Name: "查看容器详情", Code: "docker:container:get", Type: "button"},
		{Name: "启动容器", Code: "docker:container:start", Type: "button"},
		{Name: "停止容器", Code: "docker:container:stop", Type: "button"},
		{Name: "重启容器", Code: "docker:container:restart", Type: "button"},
